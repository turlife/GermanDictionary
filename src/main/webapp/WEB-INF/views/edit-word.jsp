...
<form:form method="POST" commandName="word" action="${pageContext.request.contextPath}/edit/${word.id}.html">
<table>
<tbody>
	<tr>
...
<p><a href="${pageContext.request.contextPath}/main.html">Main page</a></p>
</body>
</html>